...
<script src="http://192.168.22.71:8000/assets/js/axios.js"></script>
<link rel="stylesheet"
...
<link rel="icon" href="http://192.168.22.71:8000/img/core-img/favicon.ico">
<style>

@import url("https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700");
@import url(http://192.168.22.71:8000/css/bootstrap.min.css);
@import url(http://192.168.22.71:8000/css/animate.css);
@import url(http://192.168.22.71:8000/css/owl.carousel.css);
@import url(http://192.168.22.71:8000/css/classy-nav.min.css);
@import url(http://192.168.22.71:8000/css/magnific-popup.css);
@import url(http://192.168.22.71:8000/css/font-awesome.min.css);
@import url(http://192.168.22.71:8000/css/themify-icons.css);
@import url(http://192.168.22.71:8000/css/nice-select.css);
@import url(http://192.168.22.71:8000/css/jquery-ui.min.css);
/* :: 3.0 Base CSS */
* {
  margin: 0;
  padding: 0; }
		...
		<div class="main-header-area" id="stickyHeader">
			<div class="classy-nav-container breakpoint-off">
				...
				<nav class="classy-navbar justify-content-between" id="southNav">
					...
					<!-- Logo -->
					<a class="nav-brand" href="http://localhost:8000/"><img
						src="http://192.168.22.71:8000/img/core-img/logo.png" align="middle"> 척척약사</a>
   ...
   <section class="cart_area padding_top">
      <div class="container">
               ...
               <table class="table">
                  ...
                  <tbody>
                     <tr>
                        ...
                        target="_blank" class="site-btn" style="font-size:18px">${pill.itemName} ></a>
                              </div>
                           </div>
                        </td>
                        <td>
                           <p style="font-size:16px">${pill.entpName}</p>
                        </td>
                        <td>
										<c:choose>
											<c:when test="${empty pill.printFront}">
												<p style="font-size:16px">${pill.printBack}</p>
											</c:when>
											<c:when test="${empty pill.printBack}">
												<p style="font-size:16px">${pill.printFront}</p>
											</c:when>
											<c:otherwise>
												<p style="font-size:16px">${pill.printFront},${pill.printBack}</p>
											</c:otherwise>
										</c:choose>
                        </td>
                        <td>
                           <p style="font-size:16px">${pill.drugShape}</p>
                        </td>
                        <td>
                           <p style="font-size:16px">${pill.colorClass}</p>
                        </td>
                     </tr>
                  </tbody>
                  </c:forEach>
		...
		<div class="container pb-5">
			<div class="row">
				<div class="col-md-9 px-5 pt-5"></div>
				<div class="col-md-3 px-5 pt-5">
						<!-- Search Title -->
						<div class="filebox" onclick="location.href='http://192.168.22.71:5000/'">다시 검색하기</div>
				</div>
			</div>
		</div>
	...
	<script src="http://192.168.22.71:8000/assets/js/jquery.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery-migrate-3.0.1.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/popper.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/bootstrap.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery.easing.1.3.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery.waypoints.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery.stellar.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/owl.carousel.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery.magnific-popup.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/aos.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/jquery.animateNumber.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/bootstrap-datepicker.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/scrollax.min.js"></script>
	<script src="http://192.168.22.71:8000/assets/js/main.js"></script>

	<!-- jQuery (Necessary for All JavaScript Plugins) -->
	<script src="http://192.168.22.71:8000/js/jquery/jquery-2.2.4.min.js"></script>

	<!-- Popper js -->
	<script src="http://192.168.22.71:8000/js/popper.min.js"></script>

	<!-- Bootstrap js -->
	<script src="http://192.168.22.71:8000/js/bootstrap.min.js"></script>

	<!-- Plugins js -->
	<script src="http://192.168.22.71:8000/js/plugins.js"></script>
	<script src="http://192.168.22.71:8000/js/classy-nav.min.js"></script>
	<script src="http://192.168.22.71:8000/js/jquery-ui.min.js"></script>

	<!-- Active js -->
	<script src="http://192.168.22.71:8000/js/active.js"></script>
